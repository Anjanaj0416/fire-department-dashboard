...
export const STORAGE_KEYS = {
  AUTH_TOKEN: 'rapidaid_fire_auth_token',        // Add 'fire_'
  STATION_DATA: 'rapidaid_fire_station_data',    // Add 'fire_'
  FCM_TOKEN: 'rapidaid_fire_fcm_token',          // Add 'fire_'
};
...
export const MAP_CONFIG = {
  ...
  DEFAULT_ZOOM: 12,
  STATION_MARKER_COLOR: '#dc2626',  // Change from blue to red
  ALERT_MARKER_COLOR: '#ff6b00',    // Orange for fire
};